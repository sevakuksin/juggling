...
export const DEMOS: DemoDefinition[] = [
  ...
  },
  {
    ...
    num: "4",
    navTitle: "Pattern",
    navSubtitle: "Custom siteswap",
    pageTitle: "Custom siteswap pattern",
    pageSubtitle: "Type any siteswap; use − after a digit for reversed throws.",
    description: "Arbitrary siteswap input with reversal syntax, spawn-on-throw juggling, and runtime error detection.",
